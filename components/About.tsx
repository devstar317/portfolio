  ...
  return (
    <>
      <div className="about_left">
        <h1 className="about_left_head">Hi, I&apos;m Green Developer</h1>
        <p className="about_left_text">
          Hi! I am Green Developer from Dehradun, Uttarakhand. I am Computer Science Engineering
        ...
        <div className="about_left_socialMedia">
          ...
          <img
            src={gmail.src}
            alt=""
            onClick={() => window.open("mailto:greendev0317@gmail.com", "_blank")}
          />
        </div>
        <div
