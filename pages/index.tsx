...
const Home: NextPage<IHomeProps> = ({ jobs, projects, skills }) => {
  ...
  return (
    <div>
      <Head>
        <title>Green Developer</title>
        <meta
          name="keywords"
          content="himan_kash, Green, Developer, Green Developer, iamhiman, lpu, dehradun, software developer, web developer"
        />
        <meta
          name="description"
          content="Hey, I'm Green Developer a Software Developer from Dehradun, Uttarakhand. Here's my portfolio where you can see all my projects, blogs, and achievements."
        />
        <meta name="author" content="Green Developer" />
